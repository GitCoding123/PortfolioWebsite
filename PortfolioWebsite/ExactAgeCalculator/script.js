...
function calculateAge(e) {
    ...
    function displayResult(bDate, bMonth, bYear) {
        ...
        document.querySelector(".age-year").textContent = bYear + " Year(s)";
        document.querySelector(".age-month").textContent = bMonth + " Month(s)";
        document.querySelector(".age-day").textContent = bDate + " Day(s)";
    }
}
